...
especially if this data contains lots of different features with a strong variation 
...
Additionaly, the impact of applying either a pre- or postpruning strategy is analyzed.
...
testing strategies in model-based unbiased recursive partitioning algorithms is presented in 
