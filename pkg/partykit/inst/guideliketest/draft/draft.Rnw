...
In the unbiased recursive partitioning literature this postpruning approach is also used frequently
...
transformation function $h(Y)$ as in the CTree algorithm including both of the foregoing cases.
