...
\begin{enumerate}
\item Evaluate a discrepancy measure capturing the obervation-wise goodness of fit of $\mathcal{M}(Y,X;\hat{\beta})$.
...
r(Y_1, X_1, \hat{\beta_0}, \hat{\beta_1}) & {\color{lightgray} r(Y_1, X_1, \hat{\beta_0}, \hat{\beta_1}) \cdot X}\\
r(Y_2, X_2, \hat{\beta_0}, \hat{\beta_1}) & {\color{lightgray} r(Y_2, X_2, \hat{\beta_0}, \hat{\beta_1}) \cdot X}\\
\vdots & {\color{lightgray} \vdots} \\
r(Y_n, X_n, \hat{\beta_0}, \hat{\beta_1}) & {\color{lightgray} r(Y_n, X_n, \hat{\beta_0}, \hat{\beta_1}) \cdot X}
\end{pmatrix}
%\begin{pmatrix}
...
s(Y, X, \hat{\beta_0}, \hat{\beta_1}) = 
-2 \cdot \begin{pmatrix} 
r(Y_1, X_1, \hat{\beta_0}, \hat{\beta_1}) & r(Y_1, X_1, \hat{\beta_0}, \hat{\beta_1}) \cdot X\\
r(Y_2, X_2, \hat{\beta_0}, \hat{\beta_1}) & r(Y_2, X_2, \hat{\beta_0}, \hat{\beta_1}) \cdot X\\
\vdots & \vdots \\
r(Y_n, X_n, \hat{\beta_0}, \hat{\beta_1}) & r(Y_n, X_n, \hat{\beta_0}, \hat{\beta_1}) \cdot X
\end{pmatrix}
%\begin{pmatrix} 
...
\item Categorizing split variables can simplify calculations, however, important
