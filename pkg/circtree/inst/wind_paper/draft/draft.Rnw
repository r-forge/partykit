...
\begin{minipage}{.5\textwidth}
  %\centering
  \includegraphics[width=1.2\linewidth]{density_linear.pdf}
  \end{minipage}%
\begin{minipage}{.5\textwidth}
  %\centering
...
\caption{Illustration of a distributional model fitted to circular data by 
  ...
  Left panel: linear illustration. Right panel: circular illustration.
...
Figure~\ref{fig:densities} illustrates a distributional model fitted to circular data
