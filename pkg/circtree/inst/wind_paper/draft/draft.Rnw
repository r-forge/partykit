...
This section provides a detailed analysis of the different proposed statistal models with focus
on their predictive performance. For a comprehensive comparison of the models, $1$\,hour and 
$3$\,h wind direction forecasts are evaluated at two airports, namely Innsbruck and Vienna, with
different meteorological site characteristics.
