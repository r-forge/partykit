...
variances are restricted to be shared across splits whereas in the method proposed they
are full model parameters that are estimated and tested along with the means.
...
Su X, Wang M, Fan J (2004). ``Maximum Likelihood Regression Trees.'' 
\emph{Journal of Computational and Graphical Statistics}, \textbf{13}\,(3), 586--598. 
