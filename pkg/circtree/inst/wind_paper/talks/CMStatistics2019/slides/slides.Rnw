...
\only<1>{
  ...
  \textbf{Goal:} 
  \begin{itemize}
    \item Regression trees and random forests for circular response variable.
    \item Probabilistic/distributional modeling.
  \end{itemize} 
  ...
  \textbf{Here:} Probabilistic forecasting of wind directions for the next hours 
    at \\Innsbruck Airport, Austria \textcolor{gray}{\url{https://innsbruck-airport.panomax.com/}}. 
  
  \medskip
  
  \textbf{Prior knowledge:} Trees are natural idea for capturing abrupt 
    changes \\due to geographical position. 
}
...
%
%  \begin{center}
%  \includegraphics[width = 0.8\textwidth]{airport-innsbruck_airport-innsbruck_2019-01-12_11-20-00_left.jpg}
%  \end{center}
%  
%  \begin{center}
%  \includegraphics[width = 0.8\textwidth]{airport-innsbruck_airport-innsbruck_2019-01-12_11-20-00_right.jpg}
%  \end{center}
%}
...
{\bf Tree:}
\begin{enumerate}
\item<3-> Fit global distributional model vM$(Y; \theta)$: \\ % to the whole data set:\\
...
\visible<4>{
\node[ellipse, fill=HighlightBlue!70, align=center, scale = 0.7, minimum width=60pt, minimum height = 30pt] (n0) at (0.8, 1.7) {$\text{vM}(Y;\hat{\theta}$)};
}
\visible<5->{
...
\visible<11>{
\node[rectangle, fill=HighlightOrange!70, align=center, scale = 0.7, minimum width=50pt, minimum height = 20pt] (n1) at (0, 0) {$\text{vM}(Y_1;\hat{\theta_1}$)};
\node[rectangle, fill=HighlightOrange!70, align=center, scale = 0.7, minimum width=50pt, minimum height = 20pt] (n2) at (1.6, 0) {$\text{vM}(Y_2;\hat{\theta_2}$)};
}
\visible<11->{
\draw[-, gray, line width=0.5pt] (0.7, 1) -- (n1) node [midway, left] {\scriptsize $X \leq p$};
\draw[-, gray, line width=0.5pt] (0.9, 1) -- (n2) node [midway, right] {\scriptsize $X > p$};
...
\begin{tikzpicture}
  ...
  \node[rectangle, fill=HighlightOrange!70, align=center] (n1) at (11.5, 8) {\only<5-9>{$\bold{x}_i, \bold{x}$}};
  \draw[-, line width=1pt] (n0) -- (n1);
  ...
  \node[rectangle, fill=HighlightOrange!70, align=center] (n1_2) at (12.5+3.25, 8) {\only<8-9>{$\bold{x}_i, \bold{x}$}};
  ...
  \node[rectangle, fill=HighlightOrange!70, align=center] (n2_3) at (11+6, 7) {\only<8-9>{$\bold{x}_i$}};
  \draw[-, line width=1pt] (n2_1) -- (n2_3);
  \node[rectangle, fill=HighlightOrange!70, align=center] (n2_4) at (12+6, 7) {\only<8-9>{$\bold{x}_~$}};
...
%%
%%  \node[ellipse, fill=HighlightBlue!70, align=center] (n0) at (12, 9) {};
%%  \node[rectangle, fill=HighlightOrange!70, align=center] (n1) at (11.5, 8) {\only<2->{$i, j$}};
%%  \draw[-, line width=1pt] (n0) -- (n1);
%%  \node[ellipse, fill=HighlightBlue!70, align=center] (n2) at (12.5, 8) {};
%%  \draw[-, line width=1pt] (n0) -- (n2);
%%  \node[rectangle, fill=HighlightOrange!70, align=center] (n3) at (12, 7) {};
...
%%\pause
%%
%%\textbf{Weights:} Only observations $j$ in the same subgroup as observation $i$
%%enter the corresponding subgroup model.
%%
%%\bigskip
%%\pause
%%
%%<<sgmodel2, eval=FALSE>>=
%%sgmodel_1 <- model(response ~ treatment, data,
%%  weights = as.numeric(subgroup == 1))
%%@
%%
%%\end{frame}
%%
%%\begin{frame}[fragile]{Personalized treatment effects}
%%
%%\begin{center}
%%\resizebox{0.55\textwidth}{!}{
%%\begin{tikzpicture}
...
%%
%%  \node[ellipse, fill=HighlightBlue!70, align=center] (n0) at (12, 9) {};
%%  \node[rectangle, fill=HighlightOrange!70, align=center] (n1) at (11.5, 8) {$i, j$};
%%  \draw[-, line width=1pt] (n0) -- (n1);
%%  \node[ellipse, fill=HighlightBlue!70, align=center] (n2) at (12.5, 8) {};
%%  \draw[-, line width=1pt] (n0) -- (n2);
%%  \node[rectangle, fill=HighlightOrange!70, align=center] (n3) at (12, 7) {};
...
%%
%%\only<2->{
%%  \node[ellipse, fill=HighlightBlue!70, align=center] (n1_0) at (12+3.5, 9) {};
%%  \node[ellipse, fill=HighlightBlue!70, align=center] (n1_1) at (11.5+3.5, 8) {};
%%  \draw[-, line width=1pt] (n1_0) -- (n1_1);
%%  \node[rectangle, fill=HighlightOrange!70, align=center] (n1_2) at (12.5+3.5, 8) {\only<4->{$i, j$}};
%%  \draw[-, line width=1pt] (n1_0) -- (n1_2);
%%  \node[ellipse, fill=HighlightBlue!70, align=center] (n1_3) at (11+3.5, 7) {};
%%  \draw[-, line width=1pt] (n1_1) -- (n1_3);
%%  \node[rectangle, fill=HighlightOrange!70, align=center] (n1_4) at (12+3.5, 7) {};
%%  \draw[-, line width=1pt] (n1_1) -- (n1_4);
%%  \node[rectangle, fill=HighlightOrange!70, align=center] (n1_5) at (10.5+3.5, 6) {};
%%  \draw[-, line width=1pt] (n1_3) -- (n1_5);
%%  \node[ellipse, fill=HighlightBlue!70, align=center] (n1_6) at (11.5+3.5, 6) {};
%%  \draw[-, line width=1pt] (n1_3) -- (n1_6);
%%  \node[rectangle, fill=HighlightOrange!70, align=center] (n1_7) at (11+3.5, 5) {};
%%  \draw[-, line width=1pt] (n1_6) -- (n1_7);
%%  \node[rectangle, fill=HighlightOrange!70, align=center] (n1_8) at (12+3.5, 5) {};
%%  \draw[-, line width=1pt] (n1_6) -- (n1_8);
%%
%%  \node[ellipse, fill=HighlightBlue!70, align=center] (n2_0) at (12+6, 9) {};
%%  \node[ellipse, fill=HighlightBlue!70, align=center] (n2_1) at (11.5+6, 8) {};
...
%%  \node[rectangle, fill=HighlightOrange!70, align=center] (n2_2) at (12.5+6, 8) {};
%%  \draw[-, line width=1pt] (n2_0) -- (n2_2);
%%  \node[rectangle, fill=HighlightOrange!70, align=center] (n2_3) at (11+6, 7) {\only<4->{$j$}};
%%  \draw[-, line width=1pt] (n2_1) -- (n2_3);
%%  \node[rectangle, fill=HighlightOrange!70, align=center] (n2_4) at (12+6, 7) {\only<4->{$i$}};
%%  \draw[-, line width=1pt] (n2_1) -- (n2_4);
%%}
%%\end{tikzpicture}
%%}
...
%%
%%\only<2->{
%%\textbf{Weights:} Obtain a finer measure of similarity between
%%all observations $j$ and observation $i$ via a forest/ensemble of trees.
%%}
%%
%%\bigskip
%%
...
%%\textbf{Randomization:}
%%\begin{itemize}
%%  \item Subsample of the training data (per tree).
%%  \item Subsample of covariates (per node).
%%\end{itemize}
%%}
%%
%%\only<4>{
%%\textbf{Aggregate:} The weight of observation $j$ for modeling the treatment effect
%%for observation $i$ is the sum (or mean) of assignments to the same node
%%$\Rightarrow w_{ij} = 2$ (or equivalently $2/3$).
%%}
%%
%%\end{frame}
%%
...
\textbf{Correspondingly:} \code{disttree}, \code{distforest} for any \code{gamlss.family} or custom \code{family}.\\
