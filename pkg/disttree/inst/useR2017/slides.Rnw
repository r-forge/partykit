...
box(lwd=5)
lines(x = x, y = ytrue, col = pal["forest"], lwd = 5, main = "")
@
}
\end{center}
\endminipage
...
plot(y=y , x=x, xaxt='n', yaxt='n', ann=FALSE, col = "slategray", pch = 19)
box(lwd=5)
lines(x = x, y = ytrue, col = pal["forest"], lwd=5)
lines(x = x, y = ytrue+0.1+var, col = pal["forest"], lty = 1, lwd = 2)
lines(x = x, y = ytrue-0.1-var, col = pal["forest"], lty = 1, lwd = 2)
@
}
\end{center}
...
lines(x = x, y = ytree, col = pal["forest"], lwd=5)
@
\visible<1->{
...
box(lwd=5)
#lines(x = x, y = ytrue, col = "grey", lwd=5, main = "")
lines(x = x, y = yforest, col = pal["forest"], lwd=5, main = "")
@
}
\end{center}
...
par(mar=c(5.1,4.1,4.1,3.1))
plot(y=odata$y, x=odata$x, ylab = "y", xlab = "x", col = "slategray")
