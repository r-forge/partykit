...
\abstract{Circular response variables occur in a variety of applications, e.g., when
...
%\begin{figure}
%\includegraphics[height = 0.5\textheight,angle=90,origin=c]{circtree_plot_big.pdf}
%\caption{\label{fig:circtree} Fitted distribution tree for a circular response employing the von Mises %distribution.}\label{fig:tree}
%\end{figure}
...
parallel to the Alpine crest. At Innsbruck, the west-east aligned Inn Valley is bordered in the
