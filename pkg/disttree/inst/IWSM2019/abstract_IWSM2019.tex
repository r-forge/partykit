...
According to the fitted location parameter $\mu$ the following wind regimes can be summarized:
...
wind direction or distinct wind regime as implied by a rather low concentration 
parameter $\kappa$.
