...
to the variance $\sigma^2$ of the normal distribution. 
(See e.g., Jammalamadaka and Sengupta (2001) or Mardia and Jupp (2009) for a more detailed overview.)
The distribution parameter vector $\theta = (\mu,\kappa)$ is estimated 
by maximizing $l(y, \mu, \kappa) = log(f_{vM}(y;\mu, \kappa))$ and model scores are calculated 
by 
...
\includegraphics[width = 1.\textwidth]{circtree_plot_small.pdf}
...
\item[Schlosser, L., Hothorn, T., and Zeileis, A.] (2018).
     ...
     {\it arXiv.org E-Print Archive}, arXiv 1804.02921, \url{http://arxiv.org/abs/1804.02921}
