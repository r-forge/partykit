...
\item<7-> Choose the covariate $X$ with the strongest influence or association to
...
\draw[-, line width=0.8pt] (n0) -- (n1);
\draw[-, line width=0.8pt] (n0) -- (n2);
}
\visible<9>{
...
\item<11-> Repeat steps 1--4 recursively in the subgroups
...
mtext( side = 3, line = 1, cex = 1.2, font = 2, title )
mtext( side = 2, line = 2.3, cex = 1, font = 1, text = "Temperature [°C]" )
plot( GFS_rain24[,c(1,2)], screen=1, xaxs="i", xaxt="n", yaxs="i", ylim=range(GFS_rain24)*c(0,1.05), type = "o" )
...
mtext( side = 3, line = 1, cex = 1.2, font = 2, title )
mtext( side = 2, line = 2.3, cex = 1, font = 1, text = "Temperature [°C]" )
plot( GFS_rain24[,c(1,2,3)], screen=1, xaxs="i", xaxt="n", yaxs="i", ylim=range(GFS_rain24)*c(0,1.05), type = "o" )
...
mtext( side = 3, line = 1, cex = 1.2, font = 2, title )
mtext( side = 2, line = 2.3, cex = 1, font = 1, text = "Temperature [°C]" )
plot( GFS_rain24, screen=1, xaxs="i", xaxt="n", yaxs="i", ylim=range(GFS_rain24)*c(0,1.05), type = "o" )
