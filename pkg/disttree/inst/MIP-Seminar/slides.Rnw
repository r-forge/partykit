...
\vspace{-0.7cm}
\begin{flushleft}
\noindent {\small X = rain today, humidity\\
Y = rain tomorrow}
\end{flushleft}}
\only<4->{
\vspace{-0.5cm}
...
mtext("today", side = 4, las = TRUE, at = 14.7, line = 0.5, cex = 2.5, col = pal["forest"])
...
mtext("today", side = 4, las = TRUE, at = 7.7, line = 0.5, cex = 2.5, col = pal["forest"])
mtext("rain tomorrow", side = 2, las = FALSE, line = 1, cex = 3)
...
lines(x = x, y = ytree_up, col = pal["tree"], lwd=7)
mtext("rain", side = 4, las = TRUE, at = 16, line = 0.5, cex = 2.5, col = pal["forest"])
mtext("today", side = 4, las = TRUE, at = 14.7, line = 0.5, cex = 2.5, col = pal["forest"])
mtext("no", side = 4, las = TRUE, at = 10.3, line = 0.5, cex = 2.5, col = pal["forest"])
mtext("rain", side = 4, las = TRUE, at = 9, line = 0.5, cex = 2.5, col = pal["forest"])
...
lines(x = x, y = ytree_up, col = "blue", lwd=7)
mtext("rain", side = 4, las = TRUE, at = 16, line = 0.5, cex = 2.5, col = pal["forest"])
mtext("today", side = 4, las = TRUE, at = 14.7, line = 0.5, cex = 2.5, col = pal["forest"])
mtext("no", side = 4, las = TRUE, at = 10.3, line = 0.5, cex = 2.5, col = pal["forest"])
mtext("rain", side = 4, las = TRUE, at = 9, line = 0.5, cex = 2.5, col = pal["forest"])
...
box(lwd=5)
lines(x = x, y = ytree, col = pal["forest"], lwd=7)
lines(x = x, y = ytree_up, col = "orange", lwd=7)
lines(x = x, y = ytree2, col = pal["tree"], lwd=7)
lines(x = x, y = ytree3, col = "blue", lwd=7)
