...
\begin{minipage}{0.65\textwidth}
%\vspace{-0.5cm}
\textbf{Example:} \only<2>{Tree model}\only<3>{Forest model}\\
%\vspace{-0.8cm}
\begin{center}
\only<2>{
\vspace{-0.7cm}
\resizebox{0.6\textwidth}{!}{
<<plot_raintree, fig=TRUE, echo=FALSE, width=4.2, height=2.6>>=
par(mar=c(0,0,0,0), oma=c(0,0,0.3,0))
