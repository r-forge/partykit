...
if(at_home()){
  ...
  ## Helper function to install and load further packages
  install_n_load_package <- function(x, repos = getOption("repos")) {
  ...
  invisible(suppressMessages(lapply(c("crch", "scoringRules", "gamlss.cens"), 
    function(x) install_n_load_package(x))))
  invisible(suppressMessages(install_n_load_package("RainTyrol", 
