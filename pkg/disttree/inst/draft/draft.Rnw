...
par(mfrow = c(2,2))
set.seed(1)
qqrplot(pit_df_t, nsim = 1, main = "distributional forest", ylim = c(-5,5))
qqrplot(pit_g_t, nsim = 1, main = "prespecified GAM", ylim = c(-5,5))
qqrplot(pit_gb_t, nsim = 1, main = "boosted GAM", ylim = c(-5,5))
qqrplot(pit_ml_t, nsim = 1, main = "EMOS", ylim = c(-5,5))

@
\caption{\label{qqr_oosample} Out-of-sample QQR-plot for station Axams assessed in 2009--2012 based on models learned on data from 1985--2008.}
\end{center}
\end{figure}
