...
\newpage
\section{Rain}
In this section precipation data of 30 years is analyzed. The response variable is the meassured total precipiation within 24 hours of each day in July at the station ... .\\
...
\hline
\textbf{tp{\_}pow}: total precipitation & 12 & mean, std dev, min, max (all for 6--30 UTC)\\
\hspace*{\fill} (power transformed by 1.6) & & mean: 6--12, 12--18, 12--24, 24--30 UTC\\
& & std dev: 6--12, 12--18, 12--24, 24--30 UTC\\
\hline
\textbf{cape{\_}pow}: convective available & 12 & mean, std dev, min, max (all for 6--30 UTC)\\
\hspace*{\fill} potential energy & & mean: 6--12, 12--18, 12--24, 24--30 UTC\\
& & std dev: 6--12, 12--18, 12--24, 24--30 UTC\\
\hline
dswrf: downwards short & 4-6 & mean, std dev, min, max (all for 0--30 UTC)\\
\hspace*{\fill}ware radiation flux (sunshine) & & mean of the spread, max of the spread, (min of the spread)\\
\hline
msl: mean sea level pressure & 6 &
mean of the mean, max of the mean, min of the mean,
mean of the spread, max of the spread, min of the spread \\
\hline
pwat: preciptable water & 6 &
mean of the mean, max of the mean, min of the mean, 
mean of the spread, max of the spread, min of the spread \\
\hline
tmax: 2m maximum temperature & 6 &
mean of the mean, max of the mean, min of the mean, 
mean of the spread, max of the spread, min of the spread \\
\hline
tcolc: Total column-integrated condensate & 6 &
mean of the mean, max of the mean, min of the mean, 
mean of the spread, max of the spread, min of the spread \\
\hline
t500: temperature on 500 hPa & 6 &
mean of the mean, max of the mean, min of the mean, 
mean of the spread, max of the spread, min of the spread \\
\hline
t700: temperature on 700 hPa & 6 &
mean of the mean, max of the mean, min of the mean, 
mean of the spread, max of the spread, min of the spread \\
\hline
t850: temperature on 850 hPa & 6 &
mean of the mean, max of the mean, min of the mean, 
mean of the spread, max of the spread, min of the spread \\
\hline
tdiff500850: temperature difference & 3 &
mean, min, max \\
\hline
tdiff500700: temperature difference & 3 &
mean, min, max \\
\hline
tdiff700850: temperature difference & 3 &
mean, min, max \\
\hline
msl{\_}diff: temperature difference & 1 & 
- \\
\hline
\end{tabular}
...
\hline
model & mu link & sigma link & mu covariates & sigma covariates \\
\hline
disttree & identity & log & all covariates & all covariates \\ 
\hline
distforest & identity & log & all covariates & all covariates \\
\hline
gamlss & identity & log & manually selected covariates: & manually selected covariates \\
\hline
gamboostLSS & identity & log & all covariates & all covariates \\
\hline
EMOS & identity & log & tppowmean & tppowspread \\
\hline
\end{tabular}
...
The methods are compared in a 10x10 cross validation framework based on the resulting RMSE, log-likelihood and CRPS.\\
