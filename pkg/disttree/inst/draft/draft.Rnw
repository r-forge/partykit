...
\hline
tppow: total precipitation power transformed & tppow_mean, tppow_spread, tppow_min, tppow_max \\
& tppow_0612, tppow_1218, tppow_1824, tppow_2430 \\
\hline
capepow:    & capepow_mean, capepow_spread, capepow_min, capepow_max \\
& capepow_0612, capepow_1218, capepow_1824, capepow_2430 \\
\hline
tcloc: total cloud coverage & \\
\hline
\hline
\end{table}
...
\hline
EMOS & identity & log & tppow_mean & tppow_spread \\
\hline
\end{table}
