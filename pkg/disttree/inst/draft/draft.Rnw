...
In recent years there has been a paradigm shift from prediction/regression models for the mean to distributional regression approaches for probabilistic forecasting.
