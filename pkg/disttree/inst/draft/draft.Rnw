...
(2009--2012). \hlc{Partially, this can be attributed to random variation as
...
\citep[see Supplement~A,][and the corresponding discussion in the next section]{Schlosser+Hothorn+Stauffer:2018a}.
\hlc{Further differences are possibly due to East Tyrol lying in a different
