...
\hlc{However, exploring extensions to more flexible parametric distributions}
...
\subsection*{Supplement~B: Stationwise Evaluation}
  ...
  this supplement presents the same analysis as in Section~\ref{sec:axams} 
  of the main manuscript for 14~further meteorological stations.
