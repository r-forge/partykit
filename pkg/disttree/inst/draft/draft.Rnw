...
(PIT, \citealt{Gneiting+Balabdaoui+Raftery:2007}) \hlc{histograms for station
Axams in Supplement 2} \citep{Schlosser+Hothorn+Stauffer:2018b} \hlc{which 
...
In Supplement 1} \citep{Schlosser+Hothorn+Stauffer:2018a} \hlc{the exact
...
the stations in East Tyrol. These results are presented in Supplement 2} 
...
the extended analysis in Supplement 2} \citep{Schlosser+Hothorn+Stauffer:2018b}
...
(\citealt{Stasinopoulos+Rigby:2007}, version~\Sexpr{packageVersion("gamlss.dist")})
...
\citep[Supplement 2]{Schlosser+Hothorn+Stauffer:2018b}.
...
\hlc{The results presented in Supplement 1} \citep{Schlosser+Hothorn+Stauffer:2018a} and 
Supplement 2 \citep{Schlosser+Hothorn+Stauffer:2018b} \hlc{can be reproduced using}
