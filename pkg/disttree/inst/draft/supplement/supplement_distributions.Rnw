...
and the EMOS show only slight variations (on average not even 1\%) over different 
...
Altogether it can be stated that the left-censored at zero Gaussian distribution seems 
