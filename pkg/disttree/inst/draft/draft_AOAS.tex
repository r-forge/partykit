...
%\runtitle{Distributional Regression Forests for Probabilistic Precipitation Forecasting}
\runtitle{Distributional Regression Forests}
...
\begin{aug}
\author{\fnms{Lisa} \snm{Schlosser}\thanksref{m1}\corref{}\ead[label=e1]{Lisa.Schlosser@uibk.ac.at}
\ead[label=u1,url]{https://www.uibk.ac.at/statistics/personal/schlosser-lisa/}},
\author{\fnms{Torsten} \snm{Hothorn}\thanksref{m2}\ead[label=e2]{Torsten.Hothorn@R-project.org}
\ead[label=u2,url]{http://user.math.uzh.ch/hothorn/}},
\author{\fnms{Reto} \snm{Stauffer}\thanksref{m1}\ead[label=e3]{Reto.Stauffer@uibk.ac.at}
\ead[label=u3,url]{https://retostauffer.org/}}
\and
\author{\fnms{Achim} \snm{Zeileis}\thanksref{m1}\ead[label=e4]{Achim.Zeileis@R-project.org}
\ead[label=u4,url]{https://eeecon.uibk.ac.at/\~{}zeileis/}}

\runauthor{L. Schlosser, T. Hothorn, R. Stauffer, A. Zeileis}

\affiliation{Universit\"at Innsbruck\thanksmark{m1} and Universit\"at Z\"urich\thanksmark{m2}}


\address{Universit\"at Innsbruck \\
...
%\printead{u1}\\
%\phantom{URL:\ }\printead*{u3}\\
%\phantom{URL:\ }\printead*{u4}}


\address{Universit\"at Z\"urich \\
Institut f\"ur Epidemiologie,\\
Biostatistik und Pr\"avention \\
Hirschengraben 84\\
...
\begin{keyword}
\kwd{parametric models}
\kwd{regression trees}
\kwd{random forests}
\kwd{recursive partitioning}
...
\includegraphics{draft-plot_motivation_GLM}
\endminipage};
\node (b) at (4.5,0) 
{
\minipage{0.29\textwidth}
\centering
\setkeys{Gin}{width=0.9\textwidth}
\includegraphics{draft-plot_motivation_GAM}
\endminipage};
\node (c) at (9,0) 
{
\minipage{0.29\textwidth}
\centering
\setkeys{Gin}{width=0.9\textwidth}
\includegraphics{draft-plot_motivation_GAMLSS}
\endminipage};
\node (d) at (0,-2) 
{
\minipage{0.29\textwidth}
...
GAMLSS 
\endminipage};
\draw[-{>[scale=3, length=2, width=3]},line width=0.4pt](1.85,0)--(2.65,0);
\draw[-{>[scale=3, length=2, width=3]},line width=0.4pt](6.35,0)--(7.15,0);
\end{tikzpicture}
...
\centering
\setkeys{Gin}{width=0.9\textwidth}
\includegraphics{draft-plot_motivation_regtree}
\endminipage};
\node (b) at (4.5,0) 
{
\minipage{0.29\textwidth}
\centering
\setkeys{Gin}{width=0.9\textwidth}
\includegraphics{draft-plot_motivation_randforest}
\endminipage};
\node (c) at (9,0) 
{
\minipage{0.29\textwidth}
\centering
\setkeys{Gin}{width=0.9\textwidth}
\includegraphics{draft-plot_motivation_distforest}
\endminipage};
\node (d) at (0,-2) 
{
\minipage{0.29\textwidth}
...
\centering
\setkeys{Gin}{width=0.9\textwidth}
\includegraphics{draft-plot_motivation_disttree}
\vspace{-0.2cm}%\\
Distributional tree
\vspace{0.2cm}
\endminipage};
\draw[-{>[scale=3, length=2, width=3]},line width=0.3pt](1.85,0)--(2.65,0);
\draw[-{>[scale=3, length=2, width=3]},line width=0.3pt](6.35,0)--(7.15,0);
\draw[-{>[scale=3, length=2, width=3]},line width=0.3pt](0,-2.35)--(0,-3);
\draw[-{>[scale=3, length=2, width=3]},line width=0.3pt](2.2,-4.78)--(7.15,-2.5);
\end{tikzpicture}
...
\includegraphics{draft-rain_Axams_pred}
...
\includegraphics{draft-rain_axams_qqr_oosample}
...
\includegraphics{draft-rain_cross_axams_crps_skill_score}
...
\includegraphics{draft-rain_axams_varim}
...
\centering
\setkeys{Gin}{width=0.99\textwidth}
\includegraphics{draft-rain_all_crps_skill_score}
...
\begin{supplement}[id=suppA]
  ...
  \slink[doi]{10.1214/00-AOASXXXXSUPPA}
  \sdatatype{.pdf} 
  \sdescription{
...
\begin{supplement}[id=suppB]
  ...
  \slink[doi]{10.1214/00-AOASXXXXSUPPB}
  \sdatatype{.pdf} 
  \sdescription{
