...
view the tree in the R console, the command \texttt{\Sexpr{'print()'}} function can be
used.
}
<<math_printtree>>=
print(tr_math)
...
between the percentage of successful online \texttt{\Sexpr{'tests'}} and the exam group
