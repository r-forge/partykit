...
online tests is measured on a grid, a \new{beeswarm} plot possibly shows the relationships
even better than the scatter plot (both shown in Figure~\ref{fig:math_dp1}).
<<math_dp1, fig.width=4, fig.height=3, out.width='.48\\linewidth', fig.cap="Dependence plot for percentage of tests successfully solved.", fig.subcap=c("Scatter plot.", "Beeswarm plot.")>>=
...
\new{beeswarm} plots or a combination thereof can be used (Figure~\ref{fig:math_dp2}).
