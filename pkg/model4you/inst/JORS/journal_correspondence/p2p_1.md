...
*I thank the reviewers for the thorough evaluation of our manuscript.  All
comments have been addressed and the manuscript has been revised accordingly.
Sections in the manuscript where text was added/changed were marked in blue 
...
*We added this information to the abstrac.*
...
*We added this information to the abstrac as well as the introduction. We are currently working on allowing for inverse probability weighting, yet at this point it can not be done with the package.*
...
*Thanks for the helpful hints. We added the information on which types of models can be used currently and that we are at the moment restricting to binary covariates. Also we updated the description. Thanks for finding the mistake.*
...
*Absolutely correct. Thanks for pointing this out. We added a comment on this.*
...
*We added an example on how to use the zformula in the documentation of pmtree(). Thanks for pointing out the need for better documentation.*
...
*This is optimal as I work on Linux (Ubuntu and Debian).*
...
*Thanks for finding this issue. The reason for the differences you encountered are due to the rounding of cut points in the plot output. So rather than an error in the algorithm this is a rounding issue, which we do for estetical purposes in the plot.*
...
*Thanks for finding the typos. We fixed all of them*
...
*Thanks for this comment. We added the information to the manuscript.*
