...
<<fig=TRUE, height=8, width=14, echo=FALSE>>=
lmm_tree <- lmertree(LMM_form, data = data, maxdepth = 6)
...
In the next sections, we will assess performance of the original algorithm and proposed adaptations through more extensive empirical evaluations.
