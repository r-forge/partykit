...
plot(lmm_tree, which = "tree", type = "simple", gp = gpar(cex = .7))
...
plot(lmm_tree_r, which = "tree", type = "simple", gp = gpar(cex = .7))
...
plot(lmm_tree_c, which = "tree", type = "simple", gp = gpar(cex = .7))
